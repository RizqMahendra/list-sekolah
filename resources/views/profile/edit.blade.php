            ...
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                        ...
                        <h6 class="heading-small text-muted mb-4">Kata Sandi</h6>
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-password">Kata Sandi Saat Baru</label>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-success mt-4">Ubah Password</button>
                            </div>
                        </div>
                    </form>
                </div>
